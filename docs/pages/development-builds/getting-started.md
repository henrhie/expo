...
## Building and installing your first development build
...
After you configure your project as covered by the [Building with EAS guide](eas-build.md), you can build a development build of your project with one command:

<Tabs tabs={["For iOS Devices (Apple Developer membership required)", "For Android Devices"]}>

<Tab >

Register any devices you would like to run your development build on to your ad hoc provisioning profile:
<TerminalBlock cmd={["eas device:create"]} />

Once you have all of the iOS devices you would like to install your development build on registered, you can build your app with:
...
> ⚠️ Because adding this module changes your native runtime, you'll need to build a new development build before using it. If you forget to do so, you'll get an `Invariant Violation: Native module cannot be null.` error when you attempt to load your app.
